...
{% swagger-parameter name="categoryIds" type="array" in="body" %}
...
{% swagger-parameter name="numStandardAdults" type="integer" in="body" %}
The number of standard adults allowed in the room.
{% endswagger-parameter %}

{% swagger-parameter name="numExtraAdults" type="integer" in="body" %}
The number of standard adults allowed in the room.
{% endswagger-parameter %}

{% swagger-parameter name="extraAdultCost" type="number" in="body" %}
The price of adding an extra adult to the room.
{% endswagger-parameter %}

{% swagger-parameter name="canSmoke" type="bool" in="body" %}
Whether or not smoking is allowed in the room.
{% endswagger-parameter %}

{% swagger-parameter name="active" type="bool" in="body" %}
Whether or not venue room is active on marketplace.
{% endswagger-parameter %}

{% swagger-parameter name="marketplaceName" type="bool" in="body" %}
Whether or not venue room is active on marketplace.
{% endswagger-parameter %}
